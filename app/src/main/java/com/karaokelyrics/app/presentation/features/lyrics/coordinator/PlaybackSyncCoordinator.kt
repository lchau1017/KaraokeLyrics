...
class PlaybackSyncCoordinator @Inject constructor(
     ...
     */
    data class PlaybackSyncState(val playbackPosition: Long, val isPlaying: Boolean, val syncState: LyricsSyncState?)
     ...
     */
    operator fun invoke(lyrics: SyncedLyrics?, userSettings: UserSettings): Flow<PlaybackSyncState> = combine(
