package com.karaokelyrics.ui.testdata
...
object TestData {
     ...
     */
    fun createSimpleLines(): List<ISyncedLine> = listOf(
        ...
        SimpleSyncedLine(start = 10000, end = 12000, content = "The end")
    )

    /**
     * Creates a KaraokeLine with syllable-level timing.
     *
     ...
     * - "World" : 600ms - 1000ms
     */
    fun createKaraokeLineWithSyllables(): KaraokeLine = KaraokeLine(
        syllables = listOf(
            KaraokeSyllable(content = "Hel", start = 0, end = 300),
            KaraokeSyllable(content = "lo ", start = 300, end = 600),
            KaraokeSyllable(content = "World", start = 600, end = 1000)
        ),
        start = 0,
        end = 1000
    )
    ...
    /**
     * Creates a list of KaraokeLines with syllable timing for testing.
     */
    fun createKaraokeLines(): List<KaraokeLine> = listOf(
        KaraokeLine(
            syllables = listOf(
        ...
        KaraokeLine(
            syllables = listOf(
                KaraokeSyllable("Test", 1500, 1800),
                KaraokeSyllable("ing", 1800, 2000)
            ),
            start = 1500,
            end = 2000
        ),
        KaraokeLine(
            syllables = listOf(
                KaraokeSyllable("Ka", 2500, 2700),
                KaraokeSyllable("ra", 2700, 2900),
                KaraokeSyllable("o", 2900, 3000),
                KaraokeSyllable("ke", 3000, 3200)
            ),
            start = 2500,
            end = 3200
        )
     ...
     */
    fun createAccompanimentLine(): KaraokeLine = KaraokeLine(
        syllables = listOf(
            KaraokeSyllable("(ooh)", 0, 500)
        ),
        start = 0,
        end = 500,
