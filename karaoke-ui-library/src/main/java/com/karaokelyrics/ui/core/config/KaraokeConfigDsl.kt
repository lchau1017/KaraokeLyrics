 ...
 */
@DslMarker
annotation class KaraokeConfigDsl

/**
 * Creates a [KaraokeLibraryConfig] using a type-safe DSL builder.
 *
 * Example usage:
 * ```kotlin
 ...
 * ```
 */
fun karaokeConfig(block: KaraokeConfigBuilder.() -> Unit): KaraokeLibraryConfig {
    return KaraokeConfigBuilder().apply(block).build()
}

/**
 * Main builder for [KaraokeLibraryConfig].
 */
@KaraokeConfigDsl
class KaraokeConfigBuilder {
    ...
    internal fun build(): KaraokeLibraryConfig {
...
class AnimationsBuilder {
    ...
    internal fun build() = AnimationConfig(
...
class EffectsBuilder {
    ...
    internal fun build() = EffectsConfig(
        enableBlur = blur,
...
class ViewerBuilder {
    ...
    internal fun build() = ViewerConfig(
        type = type,
...
class LayoutBuilder {
    ...
    internal fun build(viewerConfig: ViewerConfig) = LayoutConfig(
...
class BehaviorBuilder {
    ...
    internal fun build() = BehaviorConfig(
