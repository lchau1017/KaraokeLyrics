 ...
 */
private fun createTextStyle(line: ISyncedLine, config: KyricsConfig): TextStyle {
 ...
 */
private fun calculateTextColor(line: ISyncedLine, lineUiState: LineUiState, config: KyricsConfig): Color {
    val isAccompaniment = line is KyricsLine && line.isAccompaniment
